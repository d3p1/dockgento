...
_generate_infra_files() {
    ...
    envsubst_files ".env" '${SCRIPT_USER_EMAIL},${SCRIPT_DOMAIN},${SCRIPT_MARIADB_VERSION},${SCRIPT_TRAEFIK_VERSION},${SCRIPT_SMTP_HOST},${SCRIPT_SMTP_PORT},${SCRIPT_PHP_VERSION},${SCRIPT_SEARCH_SERVICE},${SCRIPT_COMPOSER_MAGENTO_USERNAME},${SCRIPT_COMPOSER_MAGENTO_PASSWORD},${SCRIPT_MAGENTO_VERSION},${SCRIPT_MAGENTO_ADMIN_FIRSTNAME},${SCRIPT_MAGENTO_ADMIN_LASTNAME},${SCRIPT_DOC_ROOT_DIR},${SCRIPT_WEB_IMAGE_NAME},${SCRIPT_DOCKER_PATH},${SCRIPT_MARIADB_DB_NAME},${SCRIPT_MARIADB_USER},${SCRIPT_MARIADB_PASSWORD},${SCRIPT_RABBITMQ_DEFAULT_USER},${SCRIPT_RABBITMQ_DEFAULT_PASS},${SCRIPT_SEARCH_MEM_LIMIT},${SCRIPT_SEARCH_JAVA_OPTS},${SCRIPT_COMPOSE_PROFILES},${SCRIPT_COMPOSE_FILE},${SCRIPT_PHP_SENDMAIL_PATH},${SCRIPT_MAGENTO_RUN_MODE},${SCRIPT_MAGENTO_STATIC_CONTENT_DEPLOY_JOBS},${SCRIPT_MAGENTO_ADMIN_USER},${SCRIPT_MAGENTO_ADMIN_PASSWORD},${SCRIPT_MAGENTO_SEARCH_ENGINE},${SCRIPT_MAGENTO_SEARCH_ENGINE_HOST},${SCRIPT_MAGENTO_SEARCH_ENGINE_PORT},${SCRIPT_MYSQL_ROOT_PASSWORD},${SCRIPT_NGINX_WORKER_PROCESSES},${SCRIPT_NGINX_WORKER_CONNECTIONS}'
