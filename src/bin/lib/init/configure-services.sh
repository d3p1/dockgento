...
_configure_mariadb() {
    ...
    _log_env_var "SCRIPT_MARIADB_DB_NAME"
    _log_env_var "SCRIPT_MARIADB_USER"
    _log_env_var "SCRIPT_MARIADB_PASSWORD"
    _log_env_var "SCRIPT_MYSQL_ROOT_PASSWORD"
...
_configure_rabbitmq() {
    ...
    _log_env_var "SCRIPT_RABBITMQ_DEFAULT_USER"
    _log_env_var "SCRIPT_RABBITMQ_DEFAULT_PASS"
...
_configure_web() {
    ...
    _log_env_var "SCRIPT_NGINX_WORKER_PROCESSES"
    _log_env_var "SCRIPT_NGINX_WORKER_CONNECTIONS"
...
_configure_search_engine() {
    ...
    _log_env_var "SCRIPT_SEARCH_JAVA_OPTS"
    ...
    _log_env_var "SCRIPT_MAGENTO_SEARCH_ENGINE_HOST"
    _log_env_var "SCRIPT_MAGENTO_SEARCH_ENGINE_PORT"
    _log_env_var "SCRIPT_MAGENTO_SEARCH_ENGINE"
...
_configure_magento() {
	...
	_log_env_var "SCRIPT_MAGENTO_STATIC_CONTENT_DEPLOY_JOBS"
    ...
    _log_env_var "SCRIPT_MAGENTO_ADMIN_USER"
    _log_env_var "SCRIPT_MAGENTO_ADMIN_PASSWORD"
