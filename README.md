...
> Additioanlly, the `dockgento ide-configure` for [PhpStorm](https://www.jetbrains.com/phpstorm/) considers that the source code lives in a child directory to configure the startup scripts ([`Dev`](https://github.com/d3p1/dockgento/blob/2be6649c49fa3eb4321ac657906cc78b396013a0/src/bin/etc/.idea/runConfigurations/Dev.xml#L8) and [`Cache`](https://github.com/d3p1/dockgento/blob/2be6649c49fa3eb4321ac657906cc78b396013a0/src/bin/etc/.idea/runConfigurations/Cache.xml)).
